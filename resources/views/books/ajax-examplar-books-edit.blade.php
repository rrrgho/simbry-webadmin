<form action="{{ url('books-management/' . $data['id'] . '/edit-books') }}" enctype="multipart/form-data"
    method="POST">@csrf
        ...
        <div class="row">
            ...
            <div class="col-12 mt-1">
                <label for="imgInp">
                    ...
                    @if ($data['cover'] == true)
                        <img id="image-preview" src="{{ $data['cover'] }}"
                            style="width:100%; height:50%; cursor: pointer;" alt="your image" />
                    @else
                        <img id="image-preview"
                            src="https://www.canadasoccer.com/wp-content/uploads/2019/11/no-image-default.png"
                            style="width:100%; height:50%; cursor: pointer;" alt="your image" />
                    @endif
                </label>
            </div>
