<form action="{{ url('books-management/'.$data['examplar'].'/edit-books') }}" enctype="multipart/form-data" method="POST">@csrf
    <div class="modal-header">
        <h4 class="modal-title">Edit Buku</h4>
    </div>
    <div class="modal-body" id="box_examplar_edit">
        <div class="row">
            <input type="hidden" name="examplar" value="{{$data['examplar']}}">
            ...
            <div class="col-6 mt-3">
                ...
                <input required class="date form-control"  name="origin_book"  type="text" value="{{$data['origin_book']}}">
            </div>
            <div class="col-6 mt-3">
                <label for="">Nomor Panggil : </label>
                <input required class="date form-control"  name="no_panggil"  type="text" value="{{$data['no_panggil']}}">
            </div>
