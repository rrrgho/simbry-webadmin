@extends('layouts.app', [
'breadcrumbs' => [
[ 'page' => 'Menambahkan E-Books', 'link' => 'http://dashboard.com'],
],
'class' => 'off-canvas-sidebar',
'activeMainPage' => 'books-management',
'activePage' => 'E-Books',
'title' => __('Menambahkan E-Books'),
    ...
    <div class="col-md-12 noPrint">
        <div class="card">
            <div class="card-header bg-light">
                <h1 class="text-success">Data Seluruh E-Books</h1>
...
<script>
    ...
    $('#form-add-buku').submit(function(event){
        ...
        $.ajax({
            url: "{{ url('books-management/e-books') }}",
