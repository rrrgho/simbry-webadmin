...
class BooksController extends Controller
{
    ...
    public function bookDetail($id){
        ...
        return response()->json(['error' => false, 'message' => 'Success get data', 'data' => $data, 'wishlisted' => $wishlist_order ? true : false, 'your_usage' => $is_order,'is_borrowing' => $check_user_wishlist ? false : true], 200);
    }
