...
class Books extends Model
{
    ...
    protected $guarded = [];
    protected $appends = ['category','edition','locker','publisher'];
    protected $hidden = ['category_relation','edition_relation','locker_relation','publisher_relation'];
    ...
    public function edition_relation(){
        return $this->belongsTo(Edition::class, 'edition_id');
    }
    public function getEditionAttribute(){
        return $this->edition_relation->name ?? '-';
    }
